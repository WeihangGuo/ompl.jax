...
robot_srdf_path="resources/panda/panda.srdf"
...
def main():
    robot = Robot.from_urdf(robot_urdf_path, robot_srdf_path, mesh_dir=robot_mesh_dir)
    obstacles = Obstacle.from_sphere(problem, radii)
    env = JAXEnv.from_robot_and_obstacles(robot, obstacles, self_collision_margin=0, world_collision_margin=-0.01, n_checks=10)
